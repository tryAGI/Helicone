...
namespace Helicone
{
    ...
    public readonly partial struct Json : global::System.IEquatable<Json>
    {
...
#else
        public global::System.Collections.Generic.Dictionary<string, global::Helicone.Json?>? JsonVariant4 { get; }
#endif
        ...
        public bool TryPickJsonVariant4(
            ...
            [global::System.Diagnostics.CodeAnalysis.NotNullWhen(true)]
#endif
            out global::System.Collections.Generic.Dictionary<string, global::Helicone.Json?>? value)
        {
            value = JsonVariant4;
