                    ...
                    await global::Helicone.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Helicone.ResultPrompt2025ArrayString.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Helicone.ResultPrompt2025ArrayString.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
