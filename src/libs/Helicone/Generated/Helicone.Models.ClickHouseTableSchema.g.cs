...
namespace Helicone
{
    ...
    public sealed partial class ClickHouseTableSchema
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::System.Collections.Generic.IList<global::Helicone.ClickHouseTableColumn> Columns { get; set; }
        ...
        public ClickHouseTableSchema(
            string tableName,
            global::System.Collections.Generic.IList<global::Helicone.ClickHouseTableColumn> columns)
        {
