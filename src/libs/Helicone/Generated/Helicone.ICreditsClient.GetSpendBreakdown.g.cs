...
namespace Helicone
{
    public partial interface ICreditsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Helicone.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Helicone.AutoSDKHttpResponse<global::Helicone.ResultSpendBreakdownResponseString>> GetSpendBreakdownAsResponseAsync(
            global::Helicone.GetSpendBreakdownTimeRange? timeRange = default,
            string? startDate = default,
            string? endDate = default,
            global::Helicone.AutoSDKRequestOptions? requestOptions = default,
