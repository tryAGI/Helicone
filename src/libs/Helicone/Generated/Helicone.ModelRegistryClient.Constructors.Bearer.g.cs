...
namespace Helicone
{
    public sealed partial class ModelRegistryClient
    {
        /// <inheritdoc cref="ModelRegistryClient(global::System.Net.Http.HttpClient?, global::System.Uri?, global::System.Collections.Generic.List{global::Helicone.EndPointAuthorization}?, bool)"/>
        ...
        /// <summary>
        /// Creates an authenticated ModelRegistryClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static ModelRegistryClient CreateFromEnvironment(
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::Helicone.EndPointAuthorization>? authorizations = null,
            ...
            bool disposeHttpClient = true)
        {
            ...
            if (credentialValue is null)
            {
                throw new global::System.InvalidOperationException(
                    "No non-empty credential environment variable value was found. Checked: HELICONE_API_KEY.");
            }
            ...
            var client = new ModelRegistryClient(
                httpClient,
                baseUri,
                authorizations,
                options,
        ...
        /// <summary>
        /// Tries to create an authenticated ModelRegistryClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static bool TryCreateFromEnvironment(
            out ModelRegistryClient? client,
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::Helicone.EndPointAuthorization>? authorizations = null,
            global::Helicone.AutoSDKClientOptions? options = null,
            bool disposeHttpClient = true)
        {
            ...
            client = new ModelRegistryClient(
                httpClient,
                baseUri,
                authorizations,
                options,
