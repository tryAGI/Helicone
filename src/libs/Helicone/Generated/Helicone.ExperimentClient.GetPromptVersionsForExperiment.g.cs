                    ...
                    await global::Helicone.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Helicone.ResultExperimentV2PromptVersionArrayString.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Helicone.ResultExperimentV2PromptVersionArrayString.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
