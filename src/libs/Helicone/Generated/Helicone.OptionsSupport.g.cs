...
namespace Helicone
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Helicone.AutoSDKRetryOptions Retry { get; set; } = new global::Helicone.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Helicone.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Helicone.IAutoSDKHook>();
        ...
        public global::Helicone.AutoSDKClientOptions AddHook(
            global::Helicone.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Helicone.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Helicone.AutoSDKClientOptions UseAuthorizationProvider(
            global::Helicone.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Helicone.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Helicone.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Helicone.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Helicone.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Helicone.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Helicone.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Helicone.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Helicone.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Helicone.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Helicone.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Helicone.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Helicone.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Helicone.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Helicone.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Helicone.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Helicone.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Helicone.AutoSDKClientOptions clientOptions,
            global::Helicone.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Helicone.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Helicone.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Helicone.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Helicone.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Helicone.IAutoSDKHook, global::Helicone.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Helicone.AutoSDKHookContext context)
        {
